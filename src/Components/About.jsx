              ...
              <Card variant="outlined">
                <CardContent>
                  <Typography variant="subtitle1" className={styles.description}>
                    My name is Pratham Patel, I am Consultant I at Protiviti Emerging Technologies Group. I studied CS with a minor in Chemistry, which allows me to grow in many diverse ways. I've been an intern at PNC, learning new skills and technologies that are currently used in the industry right now. And I've been an undergraduate researcher and published co-author where I created scripts to analyze large amounts of data related to Alzheimer's Disease. Outside of creating things and tinkering with new technologies, I love photography and editing. The hero picture for this site's landing page is one of my personal favorites!
                  </Typography>
                </CardContent>
                <CardMedia>
